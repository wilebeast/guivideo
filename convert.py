...
# 提取音频
def get_audio_file(orig_file_name, audio_file_name):
    my_audio_clip = AudioFileClip(orig_file_name)
    my_audio_clip.write_audiofile(audio_file_name)


# 提取视频，并做视频帧提取操作
def get_video_file(orig_video_file_name, tmp_video_file_name):
...
# 合并视频、音频
def combine_video_and_audio(tmp_video_file_name, audio_file_name, output_video_file_name):
